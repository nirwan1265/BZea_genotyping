...
#BSUB -o /rsstu/users/r/rrellan/BZea/angsd_genotyping/angsd_full_snps/6_HMM_outputs/logs/hmm.%J.%I.out
#BSUB -e /rsstu/users/r/rrellan/BZea/angsd_genotyping/angsd_full_snps/6_HMM_outputs/logs/hmm.%J.%I.err

set -euo pipefail

GLDIR="/rsstu/users/r/rrellan/BZea/angsd_genotyping/angsd_full_snps/5_HMM_inputs_GL"
MAPDIR="/rsstu/users/r/rrellan/sara/ref/NAM_genetic_map"

OUTBASE="/rsstu/users/r/rrellan/BZea/angsd_genotyping/angsd_full_snps/6_HMM_outputs"
